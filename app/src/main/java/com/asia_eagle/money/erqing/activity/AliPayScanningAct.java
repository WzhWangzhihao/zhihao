 ...
 * 定制化显示扫描界面
 */
public class AliPayScanningAct extends BaseActivity implements View.OnClickListener, QRCodeView.Delegate {
...
//    private FrameLayout fl_scan_code;
     ...
     * 生成二维码
     */
    private ImageView iv_wxpay_code_erweima;
    /**
     * 生成条形码
     */
    ...
    private String WxScanPayUrl = "";
    private String WxErweimaPayUrl = "";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.ac_alipay_scanning);
        initView();
        getPersimmions();
    }
...
//        fl_scan_code = (FrameLayout) findViewById(R.id.fl_scan_code);
        ...
        iv_wxpay_code_erweima = findImageViewById(R.id.iv_wxpay_code_erweima);
        ll_receivables_code.setOnClickListener(this);
        ll_scan_code.setOnClickListener(this);
        btn_left.setOnClickListener(this);
        String type = getIntent().getStringExtra("type");
        WxScanPayUrl = MyService.API_ALIPAYSCANPAY;
        WxErweimaPayUrl = MyService.API_ALIPAYFENERATECODE;
        if ("1".equals(type) ) {
...
//                fl_scan_code.setVisibility(View.VISIBLE);
    ...
    public void WxScanPay(final String authCode) {
        ...
        OkHttpUtils.postString().url(WxScanPayUrl).mediaType(MediaType.parse("application/json"))
...
//                        finish();
//                        startActivity(new Intent(WxPayScanningAct.this, OverPayAct.class));
                        Intent intent = new Intent(AliPayScanningAct.this, OverPayAct.class);
...
//                        selectOk(authCode);
    ...
    public void GenerateCode() {
        ...
        OkHttpUtils.postString().url(WxErweimaPayUrl).mediaType(MediaType.parse("application/json"))
                .addHeader("accessToken", App.getToken().accessToken)
                .content(content).build().execute(new StringCallback() {
            @Override
            public void onError(Call call, Exception e, int id) {
            ...
            public void onResponse(String response, int id) {
                ...
                try {
                    ...
                    if (baseString.isSuccess()) {
                        count = 60;
                        new myThread1().start();
                        createEnglishQRCodeWithLogo(baseString.codeUrl);
//                        https://qr.alipay.com/bax04130wm2askh1osbw20a0
//                        createEnglishQRCodeWithLogo("https://qr.alipay.com/bax08044jznfsblmtlbg60c");
                    } else {
    ...
    private void createEnglishQRCodeWithLogo(final String content) {
        ...
        new AsyncTask<Void, Void, Bitmap>() {
            ...
            protected Bitmap doInBackground(Void... params) {
                mBitmap = BitmapFactory.decodeResource(AliPayScanningAct.this.getResources(), R.mipmap.icon);
                return QRCodeEncoder.syncEncodeQRCode(content, BGAQRCodeUtil.dp2px(AliPayScanningAct.this, 150), Color.BLACK, Color.WHITE, mBitmap);
            }

            @Override
            protected void onPostExecute(Bitmap bitmap) {
                if (bitmap != null) {
                    iv_wxpay_code_erweima.setImageBitmap(bitmap);
                } else {
...
//        App.toast("authCode");
        ...
        String url = MyService.API_ALIPAYSELECTOK + authCode;
    ...
    public void serverOK(String authCode) {
        String url = MyService.API_ALIREVERSE + authCode;
    ...
    public void dialogDropOut2(String content) {
        final Dialog dialog = new Dialog(AliPayScanningAct.this, R.style.Dialog);
    ...
    protected void onDestroy() {
        //终止掉发起支付的这个线程
        OkHttpUtils.getInstance().cancelTag("alipay");
        super.onDestroy();
    }
