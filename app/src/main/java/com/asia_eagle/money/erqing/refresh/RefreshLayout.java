package com.asia_eagle.money.erqing.refresh;
...
public class RefreshLayout extends SwipeRefreshLayout implements
     ...
     * ListView的加载中footer
     */
    private static View mListViewFooter;
    ...
    public RefreshLayout(Context context, AttributeSet attrs) {
        ...
        rl_foot = (RelativeLayout) mListViewFooter.findViewById(R.id.rl_foot);
    }
...
//			pull_to_refresh_loadmore_text.setText("已加载完全部...");
//			removeFooterView();
            mYDown = 0;
            mLastY = 0;
        }
...
//		rl_foot.setVisibility(View.GONE);
        pull_to_refresh_load_progress.setVisibility(View.GONE);
        pull_to_refresh_loadmore_text.setText("我可是有底线的");
    }
    ...
    public void UptdateisAddFooter() {
        rl_foot.setVisibility(View.VISIBLE);
        pull_to_refresh_load_progress.setVisibility(View.VISIBLE);
        pull_to_refresh_loadmore_text.setVisibility(View.VISIBLE);
        pull_to_refresh_loadmore_text.setText("正在加载...");
    }
}