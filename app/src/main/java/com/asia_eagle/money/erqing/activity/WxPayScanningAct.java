 ...
 * 定制化显示扫描界面
 */
public class WxPayScanningAct extends BaseActivity implements View.OnClickListener, QRCodeView.Delegate {
...
//    private FrameLayout fl_scan_code;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ac_wxpay_scanning);
        initView();
        getPersimmions();
    }
...
//        fl_scan_code = (FrameLayout) findViewById(R.id.fl_scan_code);
        ...
        if ("1".equals(type) || "2".equals(type)) {
            WxScanPayUrl = MyService.API_WXSCANPAY;
            WxErweimaPayUrl = MyService.API_FENERATECODE;
        } else if ("3".equals(type) || "4".equals(type)) {
            WxScanPayUrl = MyService.API_QQSCANPAY;
            WxErweimaPayUrl = MyService.API_QQFENERATECODE;
...
//                        startActivity(new Intent(WxPayScanningAct.this, OverPayAct.class));
                        Intent intent = new Intent(WxPayScanningAct.this, OverPayAct.class);
    ...
    private void createEnglishQRCodeWithLogo(final String content) {
        ...
        new AsyncTask<Void, Void, Bitmap>() {
            ...
            protected Bitmap doInBackground(Void... params) {
                mBitmap = BitmapFactory.decodeResource(WxPayScanningAct.this.getResources(), R.mipmap.icon);
                return QRCodeEncoder.syncEncodeQRCode(content, BGAQRCodeUtil.dp2px(WxPayScanningAct.this, 150), Color.BLACK, Color.WHITE, mBitmap);
            }
...
//        App.toast("authCode");
        ...
        String url = MyService.API_SELECTOK + authCode;
    ...
    public void serverOK(String authCode) {
        String url = MyService.API_REVERSE + authCode;
    ...
    public void dialogDropOut2(String content) {
        final Dialog dialog = new Dialog(WxPayScanningAct.this, R.style.Dialog);
